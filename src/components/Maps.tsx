...
const Maps = (params: any) => {
  function getMapsUrl(params: any) {
    if (params.moonOpen) {
  ...
  return (
    <div>
      ...
      >
        {params.mapsOpen && (
          <div className="absolute shadow-md top-0 h-screen w-screen max-w-screen-2xl xl:max-h-full">
            <div className="absolute top-0 right-0 mr-2.5 mt-14">
              <button
                type="button"
